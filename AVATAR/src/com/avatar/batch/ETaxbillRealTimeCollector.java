...
/**
 * 전자(세금)계산서 매출/매입내역 매시간 수집
 * @author won
 *
 */
public class ETaxbillRealTimeCollector extends AbstractSimpleBatchTask {
	...
	public JexData execute(JexData input) throws JexException, JexBIZException, Throwable {
        ...
        // 전자(세금)계산서 매출/매입내역 매시간 조회 신청 고객
        JexData idoIn1 = util.createIDOData("CUST_LDGR_R024");
        ...
        {
        	JexData subBatch = this.createSubBatch("ETaxbillRealTimeCollectorSub");
