 ...
 *
 */
public class CorpCardLimitCollectorSub extends BatchServiceBiz {

	private final static String job_id = "GET_CORP_CARD_LIMT";
	...
	private void updCardInfm(String use_intt_id, String bank_cd, String card_no, String lst_ym, String stts, String msg, JSONObject hstrData){
        try{
            ...
            JexData idoIn1 = util.createIDOData("CARD_INFM_U008");
            idoIn1.put("LIM_HIS_LST_DTM", StringUtil.null2void(hstrData.getString("REG_DATETIME"),lst_ym));
