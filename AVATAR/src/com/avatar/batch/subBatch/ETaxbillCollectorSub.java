 ...
 *
 */
public class ETaxbillCollectorSub extends BatchServiceBiz {

	private static final String job_id = "GET_ELEC_TXBL";
	...
	private void insElecTxblPtcl(JexData evdc_data, String use_intt_id, String bsnn_no, String search_gubun)
		...
		// 호출 이력
//		extnInsert(use_intt_id, "C", "0403", resData.getString("ERRCODE"), resData.getString("ERRMSG"));
