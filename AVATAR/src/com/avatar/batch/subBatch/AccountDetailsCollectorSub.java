...
public class AccountDetailsCollectorSub extends BatchServiceBiz {

	private static final String job_id = "GET_ACCT_TRNS_HSTR";
	...
	private void acctTrnsHisReg_intt(JexConnection idoCon, JexCommonUtil util, String use_intt_id, String bsnn_no)
		...
		//String endDate = SvcDateUtil.getShortDateString();
		...
		// 호출 이력
//		extnInsert(use_intt_id, "C", "0109", resData.getString("ERRCODE"), resData.getString("ERRMSG"));
	...
	private void acctTrnsHisReg_acct(JexConnection idoCon, JexCommonUtil util, String use_intt_id, String bsnn_no)
		...
		for (JexData acctInfo : idoOut1) {
			...
			if ("0".equals(acctInfo.getString("ACCT_STTS")) || "8".equals(acctInfo.getString("ACCT_STTS"))) {
	...
	private void updateAcctHisLstAcct(JexConnection idoCon, JexCommonUtil util, String use_intt_id, String fnnc_unq_no,
		...
		JexData idoIn1 = util.createIDOData("ACCT_INFM_U003");
		idoIn1.put("HIS_LST_STTS", errcode);
		idoIn1.put("HIS_LST_MSG", errmsg);
		idoIn1.put("HIS_LST_DTM", his_lst_dtm + SvcDateUtil.getShortTimeString());
		//idoIn1.put("PTL_ID", CommUtil.getPtlId());
		idoIn1.put("USE_INTT_ID", use_intt_id);
		idoIn1.put("FNNC_UNQ_NO", fnnc_unq_no);
		JexData idoOut1 = idoCon.execute(idoIn1);
	...
	private void updateAcctHisLstIntt(JexConnection idoCon, JexCommonUtil util, String use_intt_id, String errcode,
			String errmsg, String his_lst_dtm) throws JexBIZException, JexException {

		JexData idoIn1 = util.createIDOData("ACCT_INFM_U002");
		idoIn1.put("HIS_LST_STTS", errcode);
		idoIn1.put("HIS_LST_MSG", errmsg);
		idoIn1.put("HIS_LST_DTM", his_lst_dtm + SvcDateUtil.getShortTimeString());
		//idoIn1.put("PTL_ID", CommUtil.getPtlId());
