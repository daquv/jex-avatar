...
public class AccountDpsvAmtRealTimeCollectorSub extends BatchServiceBiz {

	private static final String job_id = "GET_RT_ACCT_DPSV_AMT";
	...
	private void updateAcctAmt(JexConnection idoCon, JexCommonUtil util, String use_intt_id, String fnnc_unq_no,
		...
		JexData idoIn1 = util.createIDOData("ACCT_INFM_U017");
