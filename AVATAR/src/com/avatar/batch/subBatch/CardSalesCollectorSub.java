 ...
 *
 */
public class CardSalesCollectorSub extends BatchServiceBiz {

	private static final String job_id = "GET_CARD_SALES";
	...
	public JexData execute(JexData input) throws JexException, JexBIZException, Throwable {
        ...
        String startDate = StringUtil.null2void(evdc_data.getString("APV_HIS_LST_DTM")).trim();
        ...
        if("".equals(startDate))
        {
        	...
        	startDate = SvcDateUtil.getInstance().getDate(startDate.substring(0, 8), -8, 'D');
        }

        JSONObject resData = CooconApiMgnt.data_wapi_0107(bsnn_no, "2", startDate, endDate, "1", "99999");
...
//        extnInsert(use_intt_id, "C", "0107", resData.getString("ERRCODE"), resData.getString("ERRMSG"));
        ...
        //String tranorder = (String)resData.get("TRANORDER"); //거래순서 (0:최신거래내역순,1:과거거래내역순)
        String rsltCd = "0000";
        String rsltMsg = "";
        ...
        for(Object resp : resData.getJSONArray("RESP_DATA"))
        {
         ...
         // 조회를 실패하였습니다 : 쿠콘DB에 거래 결과가 없음, 쿠콘 BATCH가 실행되기전 api요청을 한 경우
            ...
            //기존 등록된 데이타가 있으면 삭제.
            deleteApvHisData(idoCon, use_intt_id, startDate, endDate);
            ...
            for(int i = 0 ; i < hstr_data.size() ; i++)
            {
            	...
            	insertData.add(insertApvHisData(hstrData, use_intt_id));
            }
	 ...
	 */
	private JexData insertApvHisData(JSONObject hstrData, String use_intt_id) throws JexException, JexBIZException
	{
	...
	private void updEvdcSeupInfm(String use_intt_id, String last_dt, String stts, String msg)
        ...
        JexData idoIn1 = util.createIDOData("EVDC_INFM_U001");
        idoIn1.put("APV_HIS_LST_DTM"  , last_dt);
	 ...
	 * @throws JexBIZException
	 */
	private void deleteApvHisData(JexConnection idoCon, String use_intt_id, String startDate, String endDate)
			throws JexException, JexBIZException {
