...
public class AccountLoanAmtCollectorSub extends BatchServiceBiz {

	private static final String job_id = "GET_ACCT_LOAN_AMT";
	...
	private void updateAcctAmt(JexConnection idoCon, JexCommonUtil util, String use_intt_id, String fnnc_unq_no,
		...
		JexData idoIn1 = util.createIDOData("ACCT_INFM_U018");
