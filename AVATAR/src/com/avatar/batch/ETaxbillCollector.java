...
/**
 * 전자(세금)계산서 매출/매입내역 수집
 * @author won
 *
 */
public class ETaxbillCollector extends AbstractSimpleBatchTask {
	...
	public JexData execute(JexData input) throws JexException, JexBIZException, Throwable {
        ...
        JexData idoIn1 = util.createIDOData("CUST_LDGR_R012");
        ...
        for(JexData row : idoOut1)
        {
        	...
        	JexData subBatch = this.createSubBatch("ETaxbillCollectorSub");
