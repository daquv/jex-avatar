 ...
 *
 */
public class CorpCardApprovalRealTimeCollector extends AbstractSimpleBatchTask {
	...
	public JexData execute(JexData input) throws JexException, JexBIZException, Throwable {
        ...
        {
        	JexData subBatch = this.createSubBatch("CorpCardApprovalRealTimeCollectorSub");
