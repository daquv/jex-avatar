...
public class PayTaxRealTimeCollector extends AbstractSimpleBatchTask {
	...
	public JexData execute(JexData input) throws JexException, JexBIZException, Throwable {
        ...
        {
        	JexData subBatch = this.createSubBatch("PayTaxRealTimeCollectorSub");
