 ...
 *
 */
public class CashRcptPerchaseCollector extends AbstractSimpleBatchTask {
	...
	public JexData execute(JexData input) throws JexException, JexBIZException, Throwable {
        ...
        JexData idoIn1 = util.createIDOData("CUST_LDGR_R011");
        ...
        for(JexData row : idoOut1)
        {
        	...
        	JexData subBatch = this.createSubBatch("CashRcptPerchaseCollectorSub");
			subBatch.put("USE_INTT_ID", row.getString("USE_INTT_ID"));
			subBatch.put("BATCH_GB", input.getString("BATCH_GB"));
