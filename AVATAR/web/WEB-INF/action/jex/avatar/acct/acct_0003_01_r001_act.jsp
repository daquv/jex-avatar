...
<%
         ...
         *
         * @File Title   : 데이터연결_은행계좌조회
         * @File Name    : acct_0003_01_r001_act.jsp
         * @File path    : acct
         * @author       : byeolkim89 (  )
         * @Description  : 
         * @Register Date: 20201119142234
         * </pre>
         *
         * ============================================================
         * 참조
        ...
        @JexDataInfo(id="acct_0003_01_r001", type=JexDataType.WSVC)
        ...
        JexData idoIn1 = util.createIDOData("ACCT_INFM_R015");
