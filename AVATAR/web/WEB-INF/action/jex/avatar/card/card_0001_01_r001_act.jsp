...
<%
         ...
         *
         * @File Title   : 데이터_카드매출목록조회
         * @File Name    : card_0001_01_r001_act.jsp
         * @File path    : card
         * @author       : byeolkim89 (  )
         * @Description  : 데이터_카드매출목록조회
         * @Register Date: 20200123132606
         * </pre>
         *
         * ============================================================
         * 참조
        ...
        @JexDataInfo(id="card_0001_01_r001", type=JexDataType.WSVC)
     ...
     // IDO Connection
        ...
        //cnt
        JexData idoIn2 = util.createIDOData("CARD_SEL_APV_HSTR_R004"); 
        idoIn2.putAll(input);
        ...
        dynamic_0.addSQL("\n GROUP BY TRNS_DT, CARD_NO, CARD_CORP_NM, CARD_CORP_CD, DIV");
        //order
    	dynamic_0.addSQL("\n ORDER BY TRNS_DT DESC, APV_AMT DESC, CARD_CORP_CD");		
    	//paging
        ...
        JexData idoIn1 = util.createIDOData("CARD_SEL_APV_HSTR_R001");
