...
<%
         ...
         *
         * @File Title   : 은행별카드목록조회
         * @File Name    : card_0005_01_r001_act.jsp
         * @File path    : card
         * @author       : byeolkim89 (  )
         * @Description  : 은행별카드목록조회
         * @Register Date: 20201111163738
         * </pre>
         *
         * ============================================================
         * 참조
        ...
        @JexDataInfo(id="card_0005_01_r001", type=JexDataType.WSVC)
