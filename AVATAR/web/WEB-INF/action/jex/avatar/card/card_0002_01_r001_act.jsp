...
<%
         ...
         *
         * @File Title   : 데이터_카드매입목록조회
         * @File Name    : card_0002_01_r001_act.jsp
         * @File path    : card
         * @author       : byeolkim89 (  )
         * @Description  : 데이터_카드매입목록조회
         * @Register Date: 20200120164838
         * </pre>
         *
         * ============================================================
         * 참조
        ...
        @JexDataInfo(id="card_0002_01_r001", type=JexDataType.WSVC)
		...
		/* dynamic_0.addSQL("\n AND DIV = '1'");		// 승인취소여부-승인/취소 */
        
        //cnt
        JexData idoIn2 = util.createIDOData("CARD_BUY_APV_HSTR_R003"); 
        idoIn2.putAll(input);
        ...
        //order
    	dynamic_0.addSQL("\n ORDER BY APV_DT DESC, BUY_SUM DESC, MEST_NM");		// 구분-승인값
    	//paging
        ...
        JexData idoIn1 = util.createIDOData("CARD_BUY_APV_HSTR_R001");
