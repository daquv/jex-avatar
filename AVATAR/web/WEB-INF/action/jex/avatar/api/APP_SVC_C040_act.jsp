...
<%
         ...
         *
         * @File Title   : IBKCRM_회원가입
         * @File Name    : APP_SVC_C040_act.jsp
         * @File path    : api
         * @author       : vgkwnsxov (  )
         * @Description  : 
         * @Register Date: 20220412135912
         * </pre>
         *
         * ============================================================
         * 참조
        ...
        @JexDataInfo(id="APP_SVC_C040", type=JexDataType.WSVC)
        ...
        util.getLogger().debug("test Code11111111   :: " + idoOut1.toJSONString());
