...
<%
         ...
         *
         * @File Title   : 질의관리_기존 데이터 조회
         * @File Name    : srvc_0102_02_r002_act.jsp
         * @File path    : admin.srvc
         * @author       : byeolkim89 (  )
         * @Description  : 질의관리_기존 데이터 조회
         * @Register Date: 20200309110404
         * </pre>
         *
         * ============================================================
         * 참조
        ...
        @JexDataInfo(id="srvc_0102_02_r002", type=JexDataType.WSVC)
