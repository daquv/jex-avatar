...
<%
         ...
         *
         * @File Title   : 카드결제금액조회
         * @File Name    : ques_0007_01_r001_act.jsp
         * @File path    : ques
         * @author       : byeolkim89 (  )
         * @Description  : 카드결제금액조회
         * @Register Date: 20200130135918
         * </pre>
         *
         * ============================================================
         * 참조
        ...
        @JexDataInfo(id="ques_0007_01_r001", type=JexDataType.WSVC)
      ...
      //GET CARD INFO
        ...
        if(!(idoOut2.size()==0)){
        	if(!"".equals(StringUtil.null2void(input.getString("STR_DT")))){
               ...
               JexData idoIn1 = util.createIDOData("CARD_BUY_APV_HSTR_R002");
