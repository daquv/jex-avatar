...
<%
         ...
         *
         * @File Title   : 매입액조회
         * @File Name    : ques_0005_01_r001_act.jsp
         * @File path    : ques
         * @author       : byeolkim89 (  )
         * @Description  : 매입액조회
         * @Register Date: 20200130110718
         * </pre>
         *
         * ============================================================
         * 참조
        ...
        @JexDataInfo(id="ques_0005_01_r001", type=JexDataType.WSVC)
        ...
        if(!((idoOut3.get(0).getString("CNT").equals("0")) && (idoOut2.size()==0))){
        	...
        	dynamic_0.addNotBlankParameter(USE_INTT_ID, "\n AND USE_INTT_ID = ?");
     		...
     		dynamic_2.addNotBlankParameter(USE_INTT_ID, "\n AND USE_INTT_ID = ?");
