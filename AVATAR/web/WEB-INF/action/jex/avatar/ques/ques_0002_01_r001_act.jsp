...
<%
         ...
         *
         * @File Title   : 통장잔액조회
         * @File Name    : ques_0002_01_r001_act.jsp
         * @File path    : ques
         * @author       : byeolkim89 (  )
         * @Description  : 통장잔액조회
         * @Register Date: 20200130100638
         * </pre>
         *
         * ============================================================
         * 참조
         ...
         **/
         ...
         @JexDataInfo(id="ques_0002_01_r001", type=JexDataType.WSVC)
 ...
 // IDO Connection
       ...
       //GET ACCOUNT INFO.
         ...
         if(!(idoOut2.size()==0)){
	         dynamic_0.addNotBlankParameter(input.getString("TRNS_DT"), "\n AND (TRNS_DT <= ?||'%' OR TRNS_DT IS NULL)");
	         dynamic_0.addSQL("\n AND (ACCT_KIND NOT IN ('청약', '대출', '적금', '복리', '부금') OR ACCT_KIND IS NULL)");
	         //ordering
	         dynamic_0.addSQL("\n ORDER BY BANK_CD DESC , FNNC_INFM_NO DESC");
	         JexData idoIn1 = util.createIDOData("ACCT_INFM_R011");
