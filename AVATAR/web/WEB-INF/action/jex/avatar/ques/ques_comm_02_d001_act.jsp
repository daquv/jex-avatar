...
<%
         ...
         *
         * @File Title   : 고객인텐트연결정보 삭제
         * @File Name    : ques_comm_02_d001_act.jsp
         * @File path    : ques
         * @author       : byeolkim89 (  )
         * @Description  : 
         * @Register Date: 20200623142347
         * </pre>
         *
         * ============================================================
         * 참조
        ...
        @JexDataInfo(id="ques_comm_02_d001", type=JexDataType.WSVC)
        ...
        try{
			...
			if("ALL".equals(input.getString("MENU_DV"))){
				...
				while(idoOut2.next()){
					...
					JexData idoIn1 = util.createIDOData("CUST_INTE_LINK_INFM_D002");
