...
<%
         ...
         *
         * @File Title   : 거래처 내역 조회
         * @File Name    : bzaq_0001_02_r001_act.jsp
         * @File path    : bzaq
         * @author       : byeolkim89 (  )
         * @Description  : 거래처 내역 조회
         * @Register Date: 20200211144908
         * </pre>
         *
         * ============================================================
         * 참조
        ...
        @JexDataInfo(id="bzaq_0001_02_r001", type=JexDataType.WSVC)
