...
<%
         ...
         *
         * @File Title   : 연락처 목록 조회
         * @File Name    : bzaq_0002_01_r001_act.jsp
         * @File path    : bzaq
         * @author       : byeolkim89 (  )
         * @Description  : 연락처 목록 조회
         * @Register Date: 20200213154006
         * </pre>
         *
         * ============================================================
         * 참조
        ...
        @JexDataInfo(id="bzaq_0002_01_r001", type=JexDataType.WSVC)
        ...
        //cnt
        JexData idoIn2 = util.createIDOData("CNPL_INFM_R002"); 
        idoIn2.putAll(input);
        ...
        dynamic_0.addSQL("ORDER BY CNPL_NM, CLPH_NO ");
     	// paging
        ...
        JexData idoIn1 = util.createIDOData("CNPL_INFM_R001");
