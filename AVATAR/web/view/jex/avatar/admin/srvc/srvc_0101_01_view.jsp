 ...
 *
 * @File Name        : srvc_0101_01_view.jsp
 * @File path        : AVATAR/web/view/jex/avatar/admin/srvc
 * @author           : 김별 (  )
 * @Description      : 
 * @History          : 20200706141705, 김별
 * @Javascript Path  : AVATAR_STATIC/web/js/jex/avatar/admin/srvc/srvc_0101_01.js
 * @JavaScript Url   : /js/jex/avatar/admin/srvc/srvc_0101_01.js
 * </pre>
 **/
%>
<!DOCTYPE html>
...
<script type="text/javascript" src="/js/jex/avatar/admin/srvc/srvc_0101_01.js?<%=_sLocalTime_comm %>"></script>
<style>
							...
							<div class="table_wrap mgb10">
								<div class="tbl_srch">
									<table summary="">
										...
										<tbody>
											<tr>
												<th scope="row"><div>검색어</div></th>
												<td>
													<div>
														<input id="SRCH_WD" type="text" value="" placeholder="회사명, 앱명" style="width:215px;">
													</div>
												</td>
