 ...
 *
 * @File Name        : ques_0003_01_view.jsp
 * @File path        : AVATAR/web/view/jex/avatar/ques
 * @author           : 김별 (  )
 * @Description      : 입/출금내역화면/조회
 * @History          : 20200122171755, 김별
 * @Javascript Path  : AVATAR_STATIC/web/js/jex/avatar/ques/ques_0003_01.js
 * @JavaScript Url   : /js/jex/avatar/ques/ques_0003_01.js
 * </pre>
 **/
%>
<!DOCTYPE html>
...
<head>
    ...
    <script type="text/javascript" src="/js/jex/avatar/ques/ques_0003_01.js?<%=_CURR_DATETIME%>"></script>
</head>
<body>
			...
			<div class="aias_news data_y" style="display:none;">
				<table>
					...
					<tr>
						<td>
							<strong></strong><br>
							입금액은 <span class="c_blue"></span><br>
							출금액은 <span class="c_red"></span> 입니다.
						</td>
					</tr>
				</table>
			</div>
