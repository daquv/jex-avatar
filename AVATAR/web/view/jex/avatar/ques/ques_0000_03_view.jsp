 ...
 *
 * @File Name        : ques_0000_03_view.jsp
 * @File path        : AVATAR/web/view/jex/avatar/ques
 * @author           : 김별 (  )
 * @Description      : 질의오류_공통화면(시간값) - 시간값 오류, 유료
 * @History          : 20210302134649, 김별
 * @Javascript Path  : AVATAR_STATIC/web/js/jex/avatar/ques/ques_0000_03.js
 * @JavaScript Url   : /js/jex/avatar/ques/ques_0000_03.js
 * </pre>
 **/
%>
<!DOCTYPE html>
...
<head>
    ...
    <script type="text/javascript" src="/js/jex/avatar/ques/ques_0000_03.js?<%=_CURR_DATETIME%>"></script>
</head>
