 ...
 *
 * @File Name        : ques_0005_01_view.jsp
 * @File path        : AVATAR/web/view/jex/avatar/ques
 * @author           : 김별 (  )
 * @Description      : 매입액화면/조회
 * @History          : 20200122172827, 김별
 * @Javascript Path  : AVATAR_STATIC/web/js/jex/avatar/ques/ques_0005_01.js
 * @JavaScript Url   : /js/jex/avatar/ques/ques_0005_01.js
 * </pre>
 **/
%>
<!DOCTYPE html>
...
<head>
    ...
    <script type="text/javascript" src="/js/jex/avatar/ques/ques_0005_01.js?<%=_CURR_DATETIME%>"></script>
</head>
<body>
		...
		<div class="m_cont m_cont_pd"><!-- 하단 버튼 있는경우 m_cont_pd 추가 -->
			...
			<div class="aias_news data_y" style="display:none;">
				<table>
					...
					<tr>
						<td>
							<strong>2019년 12월 매입액은</strong><br>
							총 <span class="big c_red"><!-- 47,000,000원 --></span> 입니다.
						</td>
					</tr>
				</table>
			</div>
