 ...
 *
 * @File Name        : card_0006_02_view.jsp
 * @File path        : AVATAR/web/view/jex/avatar/card
 * @author           : 박지은 (  )
 * @Description      : 카드승인실시간조회 화면
 * @History          : 20210125091430, 박지은
 * @Javascript Path  : AVATAR_STATIC/web/js/jex/avatar/card/card_0006_02.js
 * @JavaScript Url   : /js/jex/avatar/card/card_0006_02.js
 * </pre>
 **/
%>
<!doctype html>
...
<head>
	...
	<script type="text/javascript" src="/js/jex/avatar/card/card_0006_02.js?<%=_CURR_DATETIME%>"></script>
</head>
<body>
	<!-- content -->
	<div class="content">
