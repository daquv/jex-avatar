 ...
 *
 * @File Name        : acct_0004_02_view.jsp
 * @File path        : AVATAR/web/view/jex/avatar/acct
 * @author           : 박지은 (  )
 * @Description      : 계좌실시간조회 화면
 * @History          : 20210121094801, 박지은
 * @Javascript Path  : AVATAR_STATIC/web/js/jex/avatar/acct/acct_0004_02.js
 * @JavaScript Url   : /js/jex/avatar/acct/acct_0004_02.js
 * </pre>
 **/
%>
<!doctype html>
...
<head>
	...
	<script type="text/javascript" src="/js/jex/avatar/acct/acct_0004_02.js?<%=_CURR_DATETIME%>"></script>
</head>
<body>
