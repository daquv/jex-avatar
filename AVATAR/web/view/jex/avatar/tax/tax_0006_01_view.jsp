 ...
 *
 * @File Name        : tax_0006_01_view.jsp
 * @File path        : AVATAR/web/view/jex/avatar/tax
 * @author           : 김별 (  )
 * @Description      : 데이터_매입현금영수증목록화면
 * @History          : 20200131165208, 김별
 * @Javascript Path  : AVATAR_STATIC/web/js/jex/avatar/tax/tax_0006_01.js
 * @JavaScript Url   : /js/jex/avatar/tax/tax_0006_01.js
 * </pre>
 **/
%>
<!DOCTYPE html>
...
<head>
    ...
    <script type="text/javascript" src="/js/jex/avatar/tax/tax_0006_01.js?<%=_CURR_DATETIME%>"></script>
</head>
<body>
<!-- content -->
	<div class="content">
		...
		<div class="m_cont m_cont_pd"><!-- 하단 버튼 있는경우 m_cont_pd 추가 -->
									...
									<div class="tbl_list type2">
										<table>
											...
											<tbody>
												<!-- <tr>
													<th>05.08</th>
													<td><span class="elipsis">돈푸대 (16521)</span></td>
													<td class="won"><em>2,000,000</em>원</td>
												</tr>
												<tr>
													<th></th>
													<td><span class="elipsis">이마트 (36514)</span></td>
			...
			<div class="notibx_wrap type2 data_n" style="display:none;">
				<div class="inner">
					...
					<div class="noti_tit">매입현금영수증 데이터가 없습니다.</div>
				</div>
			</div>
			<!-- //컨텐츠 영역 -->
		</div>
