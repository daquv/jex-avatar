 ...
 *
 * @File Name        : join_0004_06_view.jsp
 * @File path        : AVATAR/web/view/jex/avatar/user
 * @author           : 박지은 (  )
 * @Description      : 본인확인서비스 이용약관
 * @History          : 20210415170027, 박지은
 * @Javascript Path  : AVATAR_STATIC/web/js/jex/avatar/user/join_0004_06.js
 * @JavaScript Url   : /js/jex/avatar/user/join_0004_06.js
 * </pre>
 **/
%>
<!DOCTYPE html>
...
<head>
    ...
    <script type="text/javascript" src="/js/jex/avatar/user/join_0004_06.js?<%=_CURR_DATETIME%>"></script>
</head>
...
<div class="content termFixed"><!-- (modify)20210416 -->
	...
	<div class="popLayer_wrap" style="display:block;">
		<div class="popLayer_inn">
			<div class="tit_wrap">
				<h3 class="pop_tit">KCB휴대폰 본인확인 이용약관</h3>
			...
			<div class="pop_cnt mCustomScrollbar" style="max-height:100%;">
				<div class="pop_cnt_inn">
					<div>
						<h3 class="popTitle_first">KCB휴대폰 본인확인 이용약관</h3>
						<div class="servTerm">
							<dl>
								<dt>제1조 (목적)</dt>
								<dd>
									<p class="pFirst">이 약관은 본인확인서비스 대행기관인 주식회사 코리아크레딧뷰로(이하 ''회사''라 합니다)와 본인확인서비스 이용자(이하 ''이용자''라 합니다) 간에 본인확인서비스 이용에 관한 회사와 이용자의 권리와 의무, 기타 제반 사항을 정함을 목적으로 합니다.</p>
								</dd>
							</dl>
							<dl>
								<dt>제2조 (용어의 정리)</dt>
							...
							<dl>
								...
								<dd>
									<ol>
										...
										<li>② 회사는 본인확인서비스 중지에 따라 이용자에게 별도의 보상은 하지 않습니다.</li>
									</ol>
								</dd>
							</dl>
							<dl>
								<dt>제5조 (회사의 권리와 의무)</dt>
								<dd>
									<ol>
									...
									<ol>
										<li>
											...
											<ul>
												...
												<li>2. 회사 및 본인확인기관, 사이트의 저작권, 제3자의 저작권 등 기타 권리를 침해하는 행위</li>
										...
										<li>
											...
											<ul>
												<li>회사의 서비스 고객센터 연락처 : 02-708-1000, www.ok-name.co.kr</li>
											</ul>
										</li>
										<li>
							...
							<dl>
								<dt>제7조 (이용자의 개인정보보호)</dt>
								<dd>
									<ol>
										<li>① 회사는 본인확인서비스를 대행함에 있어 취득한 이용자의 정보 또는 자료를 이용자의 동의 없이 제3자에게 제공, 누설하거나 업무상 목적 외에 사용하지 않습니다.</li>
										<li>② 이용자의 개인정보 보호는 회사가 관련 법령과 회사가 수립하여 운영하는 개인정보 취급방침에 따릅니다. 자세한 회사의 개인정보 제공 범위와 보호 방침, 위탁은 서비스 홈페이지(www.ok-name.co.kr)에 제공되는 개인정보 취급방침을 참조하시기 바랍니다.</li>
									</ol>
								</dd>
							</dl>
							<dl>
