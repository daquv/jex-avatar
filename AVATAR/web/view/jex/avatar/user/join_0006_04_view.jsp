 ...
 *
 * @File Name        : join_0006_04_view.jsp
 * @File path        : AVATAR/web/view/jex/avatar/user
 * @author           : 하준태 (  )
 * @Description      : 
 * @History          : 20220401141140, 하준태
 * @Javascript Path  : AVATAR_STATIC/web/js/jex/avatar/user/join_0006_04.js
 * @JavaScript Url   : /js/jex/avatar/user/join_0006_04.js
 * </pre>
 **/
%>
<!DOCTYPE html>
...
<div class="content termFixed"><!-- (modify)20210416 -->
	...
	<div class="popLayer_wrap" style="display:block;">
		<div class="popLayer_inn">
			<div class="tit_wrap">
				<h3 class="pop_tit">IBKCRM 본인 확인 서비스 고유식별정보 처리 동의</h3>
			...
			<div class="pop_cnt mCustomScrollbar" style="max-height:100%;">
				<div class="pop_cnt_inn">
					<div>
						<h3 class="popTitle_first">IBKCRM 본인 확인 서비스 고유식별정보 처리 동의</h3><!-- (add)20210414(r4) -->
						<div class="servTerm">
							<ul>
								<li>■ 내용추가 예정</li>
							</ul>
