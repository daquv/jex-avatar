 ...
 *
 * @File Name        : join_0004_02_view.jsp
 * @File path        : AVATAR/web/view/jex/avatar/user
 * @author           : 김별 (  )
 * @Description      : 회원가입_약관동의(2.ASKAVATAR-개인정보수집및이용동의)
 * @History          : 20210414132945, 김별
 * @Javascript Path  : AVATAR_STATIC/web/js/jex/avatar/user/join_0004_02.js
 * @JavaScript Url   : /js/jex/avatar/user/join_0004_02.js
 * </pre>
 **/
%>
...
<head>
    ...
    <script type="text/javascript" src="/js/jex/avatar/user/join_0004_02.js?<%=_CURR_DATETIME%>"></script>
</head>
