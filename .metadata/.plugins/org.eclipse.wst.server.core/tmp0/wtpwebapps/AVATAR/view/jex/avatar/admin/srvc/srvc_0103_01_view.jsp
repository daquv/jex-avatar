 ...
 *
 * @File Name        : srvc_0103_01_view.jsp
 * @File path        : AVATAR/web/view/jex/avatar/admin/srvc
 * @author           : 김별 (  )
 * @Description      : 인텐트 관리 목록 화면
 * @History          : 20200309155608, 김별
 * @Javascript Path  : AVATAR_STATIC/web/js/jex/avatar/admin/srvc/srvc_0103_01.js
 * @JavaScript Url   : /js/jex/avatar/admin/srvc/srvc_0103_01.js
 * </pre>
 **/
%>
<!DOCTYPE html>
...
<script type="text/javascript" src="/js/jex/avatar/admin/srvc/srvc_0103_01.js?<%=_sLocalTime_comm %>"></script>
<style>
					...
					<div class="content fold">
						...
						<div class="content_wrap">
							...
							<div class="title_wrap">
								<div class="left"><h1>인텐트관리</h1></div>
							</div>
							<!-- //타이틀/검색 영역 -->
											...
											<tr>
												...
												<td>
													<div>
														<select id="SRCH_CD" style="width:100px;">
															<option value="0">전체</option>
															<option value="1">인텐트명</option>
															<option value="2">유사검색어</option>
															<option value="3">인텐트코드</option>
														</select>
												...
												<td>
													<div>
														...
														<label for="STTS_01"><input type="checkbox" name="STTS" class="STTS" value="8"> 중지</label>
														<label for="STTS_02"><input type="checkbox" name="STTS" class="STTS" value="9"> 삭제</label>
													</div>
												</td>
