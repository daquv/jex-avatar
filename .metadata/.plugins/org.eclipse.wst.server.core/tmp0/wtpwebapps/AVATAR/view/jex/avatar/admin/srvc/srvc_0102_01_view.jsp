 ...
 *
 * @File Name        : srvc_0102_01_view.jsp
 * @File path        : AVATAR/web/view/jex/avatar/admin/srvc
 * @author           : 김별 (  )
 * @Description      : 
 * @History          : 20200306154123, 김별
 * @Javascript Path  : AVATAR_STATIC/web/js/jex/avatar/admin/srvc/srvc_0102_01.js
 * @JavaScript Url   : /js/jex/avatar/admin/srvc/srvc_0102_01.js
 * </pre>
 **/
%>
...
<script type="text/javascript" src="/js/jex/avatar/admin/srvc/srvc_0102_01.js?<%=_sLocalTime_comm %>"></script>
<style>
					...
					<div class="content fold">
						...
						<div class="content_wrap">
							...
							<div class="title_wrap">
								<div class="left"><h1>질의API관리</h1></div>
							</div>
							<!-- //타이틀/검색 영역 -->
								...
								<div class="tbl_srch">
									<table summary="">
										...
										<tbody>
											...
											<tr>
												<th scope="row" style="padding-right:10px;"><div>상태</div></th>
												<td colspan="3">
													<div>
														<label for="STTS_01"><input type="checkbox" name="STTS" class="STTS" value="1"> 승인대기</label>
														<label for="STTS_02"><input type="checkbox" name="STTS" class="STTS" value="2"> 배포대기</label>
														<label for="STTS_03"><input type="checkbox" name="STTS" class="STTS" value="3"> 배포중</label>
														<label for="STTS_04"><input type="checkbox" name="STTS" class="STTS" value="4"> 배포중지</label>
														<label for="STTS_05"><input type="checkbox" name="STTS" class="STTS" value="5"> 반려</label>
														<label for="STTS_09"><input type="checkbox" name="STTS" class="STTS" value="9"> 삭제</label>
														<label for="STTS_00"><input type="checkbox" name="STTS" class="STTS" value="0"> 임시저장</label>
													</div>
												</td>
							...
							<div  class="title_wrap type2 cboth mgb10 mgt10"> 
								<div class="left" style="position:relative;z-index:16;">
									<a href="javascript:" class="btn_style1_b" id="btnAdmit" style="display:inline-block;"><span>승인</span></a>
