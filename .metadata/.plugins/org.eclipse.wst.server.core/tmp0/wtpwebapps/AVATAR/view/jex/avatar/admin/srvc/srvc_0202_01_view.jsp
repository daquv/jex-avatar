...
<script type="text/javascript" src="/js/jex/avatar/admin/srvc/srvc_0202_01.js?<%=_sLocalTime_comm %>"></script>
<style>
					...
					<div class="content fold">
						...
						<div class="content_wrap">
							...
							<div class="title_wrap">
								<div class="left"><h1>질의 API관리</h1></div>
							</div>
							<!-- //타이틀/검색 영역 -->
							<!-- 검색테이블--> <!-- 가입일자, 상태, 검색대상 -->
									...
									<table summary="">
										...
										<tbody>
											<tr>
												...
												<td>
													<div>
														<input id="SRCH_WD" type="text" value="" placeholder="질의명" style="width:215px;">
													</div>
												</td>
												<th scope="row"><div>카테고리</div></th>
												<td>
													<select id="CTGR_CD" style="width:130px;">
													</select>
												</td>
							...
							<div  class="title_wrap type2 cboth mgb10 mgt10"> 
								<div class="left" style="position:relative;z-index:16;">
									<a href="javascript:" class="btn_style1_b" id="btnNew" style="display:inline-block;"><span>신규등록</span></a>
								</div>
