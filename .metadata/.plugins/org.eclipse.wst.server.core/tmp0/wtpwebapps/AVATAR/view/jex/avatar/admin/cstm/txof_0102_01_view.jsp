...
<%
    ...
    // Action 결과 추출
    String excelFilePath = JexSystemConfig.get("FileStorage","path")+"txof/excelform";
	String excelFileNm = "excelform_txof.xlsx";
	
	String strFileSavePath = "txof";
 ...
 *
 * @File Name        : txof_0102_01_view.jsp
 * @File path        : AVATAR/web/view/jex/avatar/admin/cstm
 * @author           : 김별 (  )
 * @Description      : 세무사DB 일괄등록
 * @History          : 20210715151653, 김별
 * @Javascript Path  : AVATAR_STATIC/web/js/jex/avatar/admin/cstm/txof_0102_01.js
 * @JavaScript Url   : /js/jex/avatar/admin/cstm/txof_0102_01.js
 * </pre>
 **/
%>
<!DOCTYPE html>
...
<script type="text/javascript" src="/js/jex/avatar/admin/cstm/txof_0102_01.js?<%=_sLocalTime_comm %>"></script>
				...
				<div class="content">
					<div class="content fold"><!-- [D] (PARK)20161012 : 메뉴영역(접기 : class="fold") -->
						...
						<div class="content_wrap">
							...
							<!-- 리스트 테이블 -->
							<div class="tbl_layout"style="display: none;overflow-x:auto;"  name="divResult">
								<table class="tbl_result" summary="" id="tbl_title" >
									...
									<thead style="display:;">
										<tr>
											...
											<th scope="col"><div>사업장명</div></th>
											<th scope="col"><div>대표자명</div></th>
											<th scope="col"><div>업태</div></th>
											<th scope="col"><div>업종</div></th>
											<th scope="col"><div>전화번호</div></th>
											<th scope="col"><div>우편번호</div></th>
											<th scope="col"><div>주소</div></th>
											<th scope="col"><div>상세주소</div></th>
											<th scope="col"><div>전문분야</div></th>
											<th scope="col"><div>세무사명</div></th>
											<th scope="col"><div>세무사전화번호</div></th>
											<th scope="col"><div>개인정보제공동의일자</div></th>
											<th scope="col"><div>사업장연결수</div></th>
											<th></th>
										</tr>
									</thead>
