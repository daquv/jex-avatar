 ...
 *
 * @File Name        : tax_0001_02_view.jsp
 * @File path        : AVATAR/web/view/jex/avatar/tax
 * @author           : 박지은 (  )
 * @Description      : 홈텍스실시간조회 화면
 * @History          : 20210120162450, 박지은
 * @Javascript Path  : AVATAR_STATIC/web/js/jex/avatar/tax/tax_0001_02.js
 * @JavaScript Url   : /js/jex/avatar/tax/tax_0001_02.js
 * </pre>
 **/
%>
<!doctype html>
...
<head>
	...
	<script type="text/javascript" src="/js/jex/avatar/tax/tax_0001_02.js?<%=_CURR_DATETIME%>"></script>
</head>
<body>
	<!-- content -->
	<div class="content">
