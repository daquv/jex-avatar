 ...
 *
 * @File Name        : join_0002_02_view.jsp
 * @File path        : AVATAR/web/view/jex/avatar/user
 * @author           : 김별 (  )
 * @Description      : 
 * @History          : 20201207093427, 김별
 * @Javascript Path  : AVATAR_STATIC/web/js/jex/avatar/user/join_0002_02.js
 * @JavaScript Url   : /js/jex/avatar/user/join_0002_02.js
 * </pre>
 **/
%>
<!DOCTYPE html>
		...
		<div class="popLayer_inn">
			...
			<div class="pop_cnt mCustomScrollbar" style="max-height:100%;">
				<div class="pop_cnt_inn">
					<div>
						<h3 class="popTitle_first">ASK AVATAR 개인정보 수집 및 이용 동의</h3><!-- (add)20210414(r4) -->
						<div class="servTerm">
