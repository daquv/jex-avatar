 ...
 *
 * @File Name        : ques_0008_01_view.jsp
 * @File path        : AVATAR/web/view/jex/avatar/ques
 * @author           : 김별 (  )
 * @Description      : 최고매출거래처조회화면
 * @History          : 20200203111430, 김별
 * @Javascript Path  : AVATAR_STATIC/web/js/jex/avatar/ques/ques_0008_01.js
 * @JavaScript Url   : /js/jex/avatar/ques/ques_0008_01.js
 * </pre>
 **/
%>
<!DOCTYPE html>
...
<head>
    ...
    <script type="text/javascript" src="/js/jex/avatar/ques/ques_0008_01.js?<%=_CURR_DATETIME%>"></script>
</head>
<body>
			...
			<div class="aias_news data_y" style="display:none;">
				<table>
					...
					<tr>
						<td>
							<strong></strong><br>
							<span class="c_blue"></span>이며,<br>
							매출금액은 총 <span class="big c_blue"></span> 입니다.
						</td>
					</tr>
				</table>
			</div>
