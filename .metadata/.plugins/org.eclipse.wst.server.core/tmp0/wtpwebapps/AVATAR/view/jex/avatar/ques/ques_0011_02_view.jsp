 ...
 *
 * @File Name        : ques_0011_02_view.jsp
 * @File path        : AVATAR/web/view/jex/avatar/ques
 * @author           : 김별 (  )
 * @Description      : 통장 출금내역 조회 화면
 * @History          : 20200207151624, 김별
 * @Javascript Path  : AVATAR_STATIC/web/js/jex/avatar/ques/ques_0011_02.js
 * @JavaScript Url   : /js/jex/avatar/ques/ques_0011_02.js
 * </pre>
 **/
%>
<!DOCTYPE html>
...
<head>
    ...
    <script type="text/javascript" src="/js/jex/avatar/ques/ques_0011_02.js?<%=_CURR_DATETIME%>"></script>
</head>
<body>
			...
			<div class="aias_news data_y" style="display:none;">
				<table>
					...
					<tr>
						<td>
							<strong></strong><br>
							총 <span class="big c_red"></span> 입니다.
						</td>
					</tr>
				</table>
			</div>
