 ...
 *
 * @File Name        : join_0006_01_view.jsp
 * @File path        : AVATAR/web/view/jex/avatar/user
 * @author           : 하준태 (  )
 * @Description      : 
 * @History          : 20220401140447, 하준태
 * @Javascript Path  : AVATAR_STATIC/web/js/jex/avatar/user/join_0006_01.js
 * @JavaScript Url   : /js/jex/avatar/user/join_0006_01.js
 * </pre>
 **/
%>
<!DOCTYPE html>
...
<head>
    ...
    <script type="text/javascript" src="/js/jex/avatar/user/join_0006_01.js?<%=_CURR_DATETIME%>"></script>
</head>
					...
					<div class="pop_cnt mCustomScrollbar" style="max-height:100%;">
						<div class="pop_cnt_inn">
							...
							<div class="tabs_body_wrap">
								<!-- [D]SKT -->
								<div class="tabs_body">
									<h3 class="popTitle_first">통신사 이용약관</h3>
									<div class="servTerm">
										<h3 class="tit_h3 pFirst">SKT 이용 약관</h3>
										<dl>
											<dt>제1조 (목적)</dt>
											<dd>
												<p class="pFirst">이 약관은 ‘본인확인서비스’를 제공하는 에스케이텔레콤 주식 ‘회사’(이하 "회사"라 합니다)와 ‘본인확인서비스’ 이용자 (이하 ‘이용자’라 합니다)간에 ‘본인확인서비스’ 이용에 관한 ‘회사’와 ‘이용자’의 권리와 의무, 기타 제반 사항을 정함을 목적으로 합니다.</p>
											</dd>
										</dl>
										<dl>
											<dt>제2조 (용어의 정의)</dt>
											<dd>
												<ol>
													...
													<li>⑪ ‘'부가서비스'라 함은 '회사'가 '본인확인서비스'와 관련하여 추가적인 보안인증절차 등을 유료 또는 무료로 제공하는 서비스를 말하며, 유료인 경우에는 '이용자에 대해 '회사'의 이동전화서비스 청구서에 합산하여 '부가서비스' 이용요금을 청구하고 이동전화 요금과 함께 수납합니다.</li>
												</ol>
											</dd>
										</dl>
										<dl>
										...
										<dl>
											<dt>제4조 (이용 계약의 성립)</dt>
											<dd>
												<p class="pFirst">‘이용자’가 ‘사이트’ 등에 게시되거나 ‘본인확인서비스’ 이용시 공개되는 이 약관의 내용에 “동의” 버튼을 누르거나 체크하면 약관에 동의하고, ‘본인확인서비스’ 이용을 신청한 것으로 간주합니다.</p>
											</dd>
										</dl>
										<dl>
										...
										<dl>
											<dt>제15조 (약관 외 준칙)</dt>
											<dd>
												<p class="pFirst">이 약관에 명시되지 아니한 사항에 대해서는 정보통신망 이용 촉진 및 정보보호 등에 관한 법률 등 기타 관련 법령 또는 상관례에 따릅니다.</p>
											</dd>
										</dl>
										<dl>
											<dt>제16조 (관할법원)</dt>
										...
										<dl>
											<dt>부칙</dt>
											<dd>
												<p class="pFirst">(시행일) 이 약관은 공지한 날로부터 시행합니다.</p>
											</dd>
										</dl>


										<h3 class="tit_h3">Ⅰ. 본인확인서비스 이용을 위한 개인정보 수집/이용/취급위탁 동의</h3>
										<p>본인은 SK텔레콤㈜(이하 ‘회사’라 합니다)가 제공하는 본인확인서비스(이하 ‘서비스’라 합니다)를 이용하기 위해, 다음과 같이 ‘회사’가 본인의 개인정보를 수집/이용하고, 개인정보의 취급을 위탁하는 것에 동의합니다.</p>
										<dl>
											<dt>1. 수집항목</dt>
											<dd>
												<ul>
											...
											<dd>
												<div class="servTerm_tbl">
													<table summary="">
														...
														<tbody>
														<tr>
															<td><div class="tac">㈜다날, ㈜드림시큐리티, ㈜케이지모빌리언스, ㈜한국사이버결제, 한국모바일인증㈜, 씨앤케이소프트㈜, 수미온㈜,엠드림커뮤니케이션㈜, NICE평가정보㈜, 서울신용평가정보㈜</div></td>
															<td><div class="tac">본인확인정보의 정확성 여부 확인(본인확인서비스 제공), 연계정보(CI)/중복가입확인정보(DI) 생성 및 전송, 서비스 관련 상담 및 불만 처리, 휴대폰인증보호 서비스, 이용자의 서비스 이용 선호도 분석정보 제공관련 시스템 구축·광고매체 연동 및 위탁영업 등</div></td>
														</tr>
														</tbody>
													</table>
												</div>
										...
										<dl>
											...
											<dd>
												<p class="pFirst">※ 회사가 제공하는 서비스와 관련된 개인정보의 취급과 관련된 사항은, 회사의 개인정보취급방침(회사 홈페이지 www.sktelecom.com )에 따릅니다.</p>
											</dd>
										</dl>
										<h3 class="tit_h3">Ⅱ. 본인확인서비스 이용을 위한 개인정보제공 동의</h3>
										...
										<dl>
											<dt>5. 위 개인정보 제공에 동의하지 않으실 경우, 서비스를 이용할 수 없습니다.</dt>
											<dd>
												<ul>
								...
								<div class="tabs_body" style="display:none;">
									<h3 class="popTitle_first">통신사 이용약관</h3>
									<div class="servTerm">
										<h3 class="tit_h3 pFirst">KT 이용약관</h3>
										<dl>
											<dt>제1조 (목적)</dt>
											<dd>
												<p class="pFirst">본 약관은 주민등록번호 대체 본인확인서비스를 제공하는 주식회사 케이티(이하 “회사”)와 이용 고객(이하 “이용자”)간에 서비스 제공에 관한 이용조건 및 절차 등 기타 필요한 사항을 규정함을 목적으로 합니다.</p>
											</dd>
										</dl>
										<dl>
											<dt>제2조 (용어의 정의)</dt>
											<dd>
												...
												<ol>
													...
													<li>③ “KT 인증”이라 함은 회사가 제공하는 애플리케이션(Application, 이하 ‘PASS앱’)으로서 이용자가 PASS앱에 등록한 인증수단을 확인하는 행위(예. 비밀번호 입력, 지문인식 등)를 통해 이용자 본인임을 안전하게 식별 및 확인하고 단말기의 점유를 확인하는 서비스를 말합니다.</li><!-- (modify)20210521 -->
													<li>
										...
										<dl>
											...
											<dd>
												<p class="pFirst">회사는 서비스를 제공함에 있어 취득한 이용자의 정보 또는 자료를 이용자의 동의 없이 제3자에게 제공, 누설하거나 업무상 목적 외에 사용하지 않습니다.</p>
											</dd>
										</dl>
										<dl>
										...
										<dl>
											...
											<dd>
												<p class="pFirst">회사는 관련법령이 정하는 방에 따라서 이용자의 개인정보를 보호하기 위하여 노력하며, 이용자의 개인정보에 관한 사항은 관련 법령 및 회사가 정하는 개인정보처리방침에 정한 바에 따릅니다.</p>
											</dd>
										</dl>
										<dl>
											<dt>제12조 (개인정보의 처리)</dt>
										...
										<dl>
											<dt>제13조 (약관 외 준칙)</dt>
											<dd>
												<p class="pFirst">본 약관에 명시되지 아니한 사항에 대해서는 정보통신망 이용 촉진 및 정보보호 등에 관한 법률, 개인정 보보호법 등 기타 관련법령 또는 상관례에 따릅니다.</p>
											</dd>
										</dl>
										<dl>
											<dt>부칙</dt>
											<dd>
												<p class="pFirst">(시행일) 이 약관은 공시한 날로부터 시행합니다.</p>
											</dd>
										</dl>
										<dl>
											<dt>부칙</dt>
											<dd>
												<p class="pFirst">(시행일) 이 약관은 2015년 4월 29일부터 시행합니다.</p>
											</dd>
										</dl>
										<dl>
											<dt>부칙</dt>
											<dd>
												<p class="pFirst">(시행일) 이 약관은 2016년 8월 2일부터 시행합니다.</p>
											</dd>
										</dl>
										<dl>
											<dt>부칙</dt>
											<dd>
												<p class="pFirst">(시행일) 이 약관은 2018년 8월 2일부터 시행합니다.</p>
											</dd>
										</dl>
									</div>
								</div>
								...
								<div class="tabs_body" style="display:none;">
									<h3 class="popTitle_first">통신사 이용약관</h3>
									<div class="servTerm">
										<h3 class="tit_h3 pFirst">LGU+ 이용 약관</h3>
										<dl>
											<dt>제 1조 (목적)</dt>
											<dd>
												<p class="pFirst">본 약관은 주민번호를 대체한 휴대폰 본인확인서비스(이하 “서비스”)를 제공하는 LG유플러스(이하 “회사”)와 이용 고객(이하 “이용자”)간에 서비스 제공에 관한 이용조건 및 절차 등 기타 필요한 사항을 정함을 목적으로 합니다.</p>
											</dd>
										</dl>
										<dl>
											<dt>제 2조 (용어의 정리)</dt>
										...
										<dl>
											<dt>제 4조 (접근매체의 관리 등)</dt>
											<dd>
												<ol>
													<li>1. 이용자는 접근매체를 제3자에게 대여하거나 사용을 위임하거나 양도 또는 담보 목적으로 제공할 수 없습니다.</li>
													<li>2. 이용자는 자신의 접근매체를 제3자에게 제공 또는 노출하거나 방치하여서는 안되며, 접근매체의 도용이나 위변조를 방지하기 위해 충분한 주의를 기울여야 합니다.</li>
												</ol>
											</dd>
										</dl>
										<dl>
											...
											<dd>
												<ol>
													<li>1. 서비스는 본인명의의 휴대폰을 소지하고 이동전화 서비스를 정상적으로 계속 이용하고 있는 이용자에 한하여 서비스를 제공합니다. {회사의 '이동전화이용약관'상 이용 정지(제한 포함), 일시 정지, 계약해지(개통취소 포함) 상태인 이용자에게는 제공 되지 않습니다.</li><!-- (modify)20210517 -->
													<li>2. 서비스는 이용자가 주민등록번호를 입력하지 아니하고 본인의 생년월일과 본인 명의 또는 법인 명의로 된 휴대폰정보를 이용하여 본인 식별 또는 본인 확인이 가능하도록 하는 휴대폰인증 서비스 입니다.</li>
													<li>3. 회사는 인증대행사를 통해 인터넷사업자에게 서비스를 제공하며, 인터넷사업자는 회원가입, ID/PW찾기, 성인인증 등 이용자의 본인확인이 필요한 경우 이용자에게 서비스를 제공 합니다.</li>
													<li>4. 이용자가 자신의 생년월일, 성명, 성별, 내/외국인, 휴대폰번호, 통신사 등의 정보를 입력(단, 제1항 제2호의 경우에는 이용자가 법인 명의 휴대폰을 통한 본인확인서비스 가입 시 등록한 비밀번호를 추가로 입력)한 후 입력한 정보가 이용자 본인의 정보와 일치한 경우에는 이용자 본인 명의 또는 법인 명의의 휴대폰번호로 수신된 1회성 비밀번호(이하 “승인번호”)를 정확하게 입력하면 본인 식별 또는 본인 확인이 이루어 집니다.</li>
													<li>5. 전항에 따라 본인확인이 완료 된 이용자에 대해서는 본인확인정보와 중복가입확인정보 및 연계정보가 인터넷사업자에게 제공되며, 인터넷사업자가 중복가입확인정보 또는 연계정보 등을 이용하여 이용자 관리 및 컨텐츠를 제공 운영 합니다.</li>
												</ol>
											</dd>
										</dl>
										<dl>
											<dt>제 6조 (서비스 제공시간)</dt>
											<dd>
												<p class="pFirst">회사는 연중무휴 1일 24시간 서비스를 제공함을 원칙으로 합니다. 다만, 회사는 서비스 설비의 장애, 서비스 이용의 폭주 등 기술상의 이유로 서비스를 일시 정지할 수 있고, 서비스 설비 정기 점검 등 운영상의 목적으로 시간을 정하고 공지한 후 서비스를 일시 정지할 수 있습니다.</p>
											</dd>
										</dl>
										<dl>
											<dt>제 7조 (회사의 권리와 의무)</dt>
											<dd>
												<ol>
										...
										<dl>
											...
											<dd>
												<ol>
													...
													<li>3. 이용자가 본 약관을 위반하여 회사에 손해가 발생한 경우에는 이용자가 모든 손해를 배상하여 합니다.</li>
												</ol>
											</dd>
										</dl>
										<dl>
											<dt>제 9조 (본인인증 정보의 제공금지)</dt>
											<dd>
												<p class="pFirst">회사는 서비스를 제공함에 있어 취득한 이용자의 정보 또는 자료를 이용자의 동의 없이 제3자에게 제공, 누설하거나 서비스 목적 외에 사용하지 않습니다.</p>
											</dd>
										</dl>
										<dl>
											<dt>제 10조 (서비스의 안정성 확보)</dt>
											<dd>
												<ol>
										...
										<dl>
											<dt>제 11조 (이용자의 개인정보보호)</dt>
											<dd>
												<p class="pFirst">회사는 관련법령이 정하는 방에 따라서 이용자의 개인정보를 보호하기 위하여 노력하며, 이용자의 개인정보에 관한 사항은 관련 법령 및 회사가 정하는 개인정보취급방침에 정한 바에 따릅니다.</p>
											</dd>
										</dl>
										<dl>
											<dt>제 12조 (개인정보의 처리)</dt>
											<dd>
												<ol>
													<li>
														1. 회사는 서비스 제공을 위하여 수집된 본인확인정보의 취급 및 관리 등의 업무를 스스로 수행함을 원칙으로 하나, 필요한 경우 아래 표와 같이 회사가 선정한 사업자에게 위탁할 수 있습니다.
														<ul class="inDepth">
															<li><strong>[개인정보의 취급 위탁]</strong></li>
															<li>본인확인 서비스 중계 업무 제공</li>
														</ul>
														<div class="servTerm_tbl">
															<table summary="">
																<caption></caption>
																...
																<thead>
																<th><div>수탁자</div></th>
																<th><div>위탁업무내용</div></th>
																</thead>
																<tbody>
																<tr>
																	<td><div class="tac">에스씨아이평가정보㈜</div></td>
																	<td><div class="tac">연계정보,중복가입확인정보 생성 및 전송<br>본인확인 서비스 중계 업무 제공</div></td>
																</tr>
																<tr>
																	<td><div class="tac">한국모바일인증㈜</div></td>
																	<td><div class="tac">본인확인 서비스 중계 업무 제공</div></td>
																</tr>
																<tr>
																	<td><div class="tac">코리아크레딧뷰로㈜</div></td>
																	<td><div class="tac">본인확인 서비스 중계 업무 제공</div></td>
																</tr>
																<tr>
																	<td><div class="tac">NICE평가정보㈜</div></td>
																	<td><div class="tac">연계정보, 중복가입확인정보 생성 및 전송</div></td>
																</tr>
																<tr>
																	<td><div class="tac">㈜ 다날</div></td>
																	<td><div class="tac">본인확인 서비스 중계 업무 제공</div></td>
																</tr>
																<tr>
																	<td><div class="tac">㈜NHN한국사이버결제</div></td>
																	<td><div class="tac">본인확인 서비스 중계 업무 제공</div></td>
																</tr>
																<tr>
																	<td><div class="tac">㈜드림시큐리티</div></td>
																	<td><div class="tac">본인확인 서비스 중계 업무 제공</div></td>
																</tr>
																<tr>
																	<td><div class="tac">KG모빌리언스</div></td>
																	<td><div class="tac">본인확인 서비스 중계 업무 제공</div></td>
																</tr>
																<tr>
																	<td><div class="tac">CS리더,LB휴넷,아이알링크 주식회사,(주)씨에스원파트너	</div></td>
																	<td><div class="tac">고객센터 운영</div></td>
																</tr>
																<tr>
																	<td><div class="tac">미디어로그</div></td>
																	<td><div class="tac">PASS 어플리케이션 및 웹사이트 운영/관리</div></td>
																</tr>
																<tr>
																	<td><div class="tac">아톤</div></td>
																	<td><div class="tac">PASS 서비스 장애 및 VOC 처리</div></td>
																</tr>
																</tbody>
															</table>
														</div>
													</li>
													<li>2. 회사는 서비스 제공시 수집된 식별정보(중복가입확인정보, 연계정보)는 본인 식별 및 확인 위한 목적으로 회사 또는 인증 대행사를 통해 인터넷사업자에게 제공할 수 있습니다.</li>
										...
										<dl>
											<dt>제13조 (약관 외 준칙)</dt>
											<dd>
												<p class="pFirst">본 약관에 명시되지 아니한 사항에 대해서는 정보통신망 이용 촉진 및 정보보호 등에 관한 법률 등 기타 관련 법령 또는 상관례에 따릅니다.</p>
											</dd>
										</dl>
										<dl>
											<dt>부칙</dt>
