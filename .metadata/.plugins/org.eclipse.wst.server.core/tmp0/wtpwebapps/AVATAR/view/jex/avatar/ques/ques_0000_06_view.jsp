 ...
 *
 * @File Name        : ques_0000_06_view.jsp
 * @File path        : AVATAR/web/view/jex/avatar/ques
 * @author           : 김예지 (  )
 * @Description      : ques_0000_02과 동일한 화면. 단, session체크 안함
 * @History          : 20211222162349, 김예지
 * @Javascript Path  : AVATAR_STATIC/web/js/jex/avatar/ques/ques_0000_06.js
 * @JavaScript Url   : /js/jex/avatar/ques/ques_0000_06.js
 * </pre>
 **/
%>
<!DOCTYPE html>
...
<head>
    ...
    <script type="text/javascript" src="/js/jex/avatar/ques/ques_0000_06.js?<%=_CURR_DATETIME%>"></script>
</head>
