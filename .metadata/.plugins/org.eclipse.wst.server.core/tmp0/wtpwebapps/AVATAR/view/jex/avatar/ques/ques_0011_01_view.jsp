 ...
 *
 * @File Name        : ques_0011_01_view.jsp
 * @File path        : AVATAR/web/view/jex/avatar/ques
 * @author           : 김별 (  )
 * @Description      : 통장 입금내역 조회 화면
 * @History          : 20200207151453, 김별
 * @Javascript Path  : AVATAR_STATIC/web/js/jex/avatar/ques/ques_0011_01.js
 * @JavaScript Url   : /js/jex/avatar/ques/ques_0011_01.js
 * </pre>
 **/
%>
<!DOCTYPE html>
...
<head>
    ...
    <script type="text/javascript" src="/js/jex/avatar/ques/ques_0011_01.js?<%=_CURR_DATETIME%>"></script>
</head>
<body>
