 ...
 *
 * @File Name        : plfm_0102_01_view.jsp
 * @File path        : AVATAR/web/view/jex/avatar/admin/plfm
 * @author           : 김별 (  )
 * @Description      : 
 * @History          : 20200710142338, 김별
 * @Javascript Path  : AVATAR_STATIC/web/js/jex/avatar/admin/plfm/plfm_0102_01.js
 * @JavaScript Url   : /js/jex/avatar/admin/plfm/plfm_0102_01.js
 * </pre>
 **/
%>
<!DOCTYPE html>
...
<script type="text/javascript" src="/js/jex/avatar/admin/plfm/plfm_0102_01.js?<%=_sLocalTime_comm %>"></script>
<style>
					...
					<div class="content fold">
						...
						<div class="content_wrap">
							...
							<div class="title_wrap">
								<div class="left"><h1>컨텐츠공급사관리</h1></div>
							</div>
							<!-- //타이틀/검색 영역 -->
									...
									<table summary="">
										...
										<tbody>
											<tr>
												...
												<th scope="row" style="text-align:right;padding-right:10px;"><div>검색대상</div></th>
												<td>
													<div>
							...
							<div  class="title_wrap type2 cboth mgb10 mgt10"> 
								<div class="left" style="position:relative;z-index:16;">
									<a href="javascript:" class="btn_style1_b" id="cmdNew" style="display:inline-block;"><span>등록</span></a>
								</div>
