 ...
 *
 * @File Name        : bzaq_0001_01_view.jsp
 * @File path        : AVATAR/web/view/jex/avatar/bzaq
 * @author           : 김별 (  )
 * @Description      : 거래처 목록 화면
 * @History          : 20200211085546, 김별
 * @Javascript Path  : AVATAR_STATIC/web/js/jex/avatar/bzaq/bzaq_0001_01.js
 * @JavaScript Url   : /js/jex/avatar/bzaq/bzaq_0001_01.js
 * </pre>
 **/
%>
<!DOCTYPE html>
...
<head>
    ...
    <script type="text/javascript" src="/js/jex/avatar/bzaq/bzaq_0001_01.js?<%=_CURR_DATETIME%>"></script>
</head>
<body>
<!-- content -->
	<div class="content">
		...
		<div class="m_cont m_cont_pd"><!-- 하단 버튼 있는경우 m_cont_pd 추가 -->
			...
			<div class="sch_bx avt data_y" style="padding-top: 9px;">
				<div class="sch_bx_in">
					...
					<input type="text" class="SRCH_WD" placeholder="검색어를 입력하세요." value="">
				</div>
			</div>
			<!-- //검색영역(검색 전) -->
			...
			<div class="sch_bx avt ipt" style="display:none;">
				<div class="sch_bx_in">
					<input type="text" class="SRCH_WD" placeholder="" value="주식회사">
			...
			<div class="m_info_wrap data_y">
				<div class="m_info_bx line_list">
					<ul>
						<!-- <li><span class="txt">우리축산물</span><a class="btn"></a></li> -->
					</ul>
				</div>
			</div>
			<!-- 컨텐츠 영역 -->
			<div class="notibx_wrap type2 data_n" style="display:none;">
				<div class="inner">
					...
					<div class="noti_tit">거래처 데이터가 없습니다.</div>
				</div>
			</div>
			<!-- //컨텐츠 영역 -->
		</div>
