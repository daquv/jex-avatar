 ...
 *
 * @File Name        : cstm_0301_01_view.jsp
 * @File path        : AVATAR/web/view/jex/avatar/admin/cstm
 * @author           : 김별 (  )
 * @Description      : 
 * @History          : 20210405145247, 김별
 * @Javascript Path  : AVATAR_STATIC/web/js/jex/avatar/admin/cstm/cstm_0301_01.js
 * @JavaScript Url   : /js/jex/avatar/admin/cstm/cstm_0301_01.js
 * </pre>
 **/
%>
<!DOCTYPE html>
...
<script type="text/javascript" src="/js/jex/avatar/admin/cstm/cstm_0301_01.js?<%=_sLocalTime_comm %>"></script>
</head>
<style>
												...
												<td>
													<div>
														<select id="SRCH_CD" style="width:100px;">
															...
															<option value="3">표제어</option>
															<option value="4">독음</option>
														</select>
