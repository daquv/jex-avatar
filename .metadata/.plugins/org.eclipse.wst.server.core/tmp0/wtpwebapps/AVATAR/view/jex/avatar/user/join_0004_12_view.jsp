 ...
 *
 * @File Name        : join_0004_12_view.jsp
 * @File path        : AVATAR/web/view/jex/avatar/user
 * @author           : 박지은 (  )
 * @Description      : 회원가입_약관동의(제로페이 개인정보 수집 및 이용 동의)
 * @History          : 20210908165350, 박지은
 * @Javascript Path  : AVATAR_STATIC/web/js/jex/avatar/user/join_0004_12.js
 * @JavaScript Url   : /js/jex/avatar/user/join_0004_12.js
 * </pre>
 **/
%>
<!DOCTYPE html>
...
<head>
    ...
    <script type="text/javascript" src="/js/jex/avatar/user/join_0004_12.js?<%=_CURR_DATETIME%>"></script>
</head>
...
<div class="content termFixed"><!-- (modify)20210416 -->
	...
	<div class="popLayer_wrap" style="display:block;">
		<div class="popLayer_inn">
			<div class="tit_wrap">
				<h3 class="pop_tit">제로페이 개인정보 수집 및 이용 동의</h3>
			...
			<div class="pop_cnt mCustomScrollbar" style="max-height:100%;">
				<div class="pop_cnt_inn">
					<div>
						<h3 class="popTitle_first">제로페이 개인정보 수집 및 이용 동의</h3><!-- (add)20210414(r4) -->
						<div class="servTerm">
							<ul>
								<li>■ 내용추가 예정</li>
							</ul>
