 ...
 *
 * @File Name        : ques_0000_05_view.jsp
 * @File path        : AVATAR/web/view/jex/avatar/ques
 * @author           : 김예지 (  )
 * @Description      : 질의_데이터없음 화면
 * @History          : 20211222162130, 김예지
 * @Javascript Path  : AVATAR_STATIC/web/js/jex/avatar/ques/ques_0000_05.js
 * @JavaScript Url   : /js/jex/avatar/ques/ques_0000_05.js
 * </pre>
 **/
%>
<!DOCTYPE html>
...
<head>
    ...
    <script type="text/javascript" src="/js/jex/avatar/ques/ques_0000_05.js?<%=_CURR_DATETIME%>"></script>
</head>
