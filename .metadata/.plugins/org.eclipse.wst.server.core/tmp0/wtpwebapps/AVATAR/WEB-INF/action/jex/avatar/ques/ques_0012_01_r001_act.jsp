...
<%
         ...
         *
         * @File Title   : 카드매출내역조회
         * @File Name    : ques_0012_01_r001_act.jsp
         * @File path    : ques
         * @author       : byeolkim89 (  )
         * @Description  : 카드매출내역조회
         * @Register Date: 20200207160444
         * </pre>
         *
         * ============================================================
         * 참조
        ...
        @JexDataInfo(id="ques_0012_01_r001", type=JexDataType.WSVC)
      ...
      //GET EVDC INFO
        ...
        if(!(idoOut3.get(1).getString("CNT").equals("0"))){
    		...
    		dynamic_0.addSQL("\n GROUP BY CARD_CORP_NM");
    		dynamic_0.addSQL("\n ORDER BY AMT_SUM DESC, CARD_CORP_NM");
            JexData idoIn1 = util.createIDOData("CARD_SEL_RCV_HSTR_R001");
