...
<%
         ...
         *
         * @File Title   : 최고매출거래처조회
         * @File Name    : ques_0008_01_r001_act.jsp
         * @File path    : ques
         * @author       : byeolkim89 (  )
         * @Description  : 최고매출거래처조회
         * @Register Date: 20200203132252
         * </pre>
         *
         * ============================================================
         * 참조
        ...
        @JexDataInfo(id="ques_0008_01_r001", type=JexDataType.WSVC)
...
// IDO Connection
        ...
        if(!( (idoOut3.get(0).getString("CNT").equals("0")) && (idoOut3.get(1).getString("CNT").equals("0"))) ){
        	JexData idoIn1 = util.createIDOData("ELEC_TXBL_PTCL_R006");
