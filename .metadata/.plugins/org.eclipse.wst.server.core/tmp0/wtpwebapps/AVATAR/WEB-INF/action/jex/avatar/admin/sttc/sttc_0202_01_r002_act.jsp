...
<%
         ...
         *
         * @File Title   : 어드민 데이터가져오기등록현황 
         * @File Name    : sttc_0202_01_r002_act.jsp
         * @File path    : admin.sttc
         * @author       : kth91 (  )
         * @Description  : 
         * @Register Date: 20200309172911
         * </pre>
         *
         * ============================================================
         * 참조
        ...
        @JexDataInfo(id="sttc_0202_01_r002", type=JexDataType.WSVC)
...
// 			dynamic_1.addNotBlankParameter(input.getString("END_DT"), " ?||'235959' ");
        ...
        JexData idoIn1 = util.createIDOData("CUST_LDGR_R007");
