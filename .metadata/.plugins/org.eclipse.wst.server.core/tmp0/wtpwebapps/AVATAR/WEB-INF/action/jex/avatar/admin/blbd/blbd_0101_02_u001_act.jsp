...
<%
         ...
         *
         * @File Title   : 게시글 수정
         * @File Name    : blbd_0101_02_u001_act.jsp
         * @File path    : admin.blbd
         * @author       : byeolkim89 (  )
         * @Description  : 
         * @Register Date: 20200902171103
         * </pre>
         *
         * ============================================================
         * 참조
        ...
        @JexDataInfo(id="blbd_0101_02_u001", type=JexDataType.WSVC)
        ...
        try{
	    	...
	    	// 게시글 내용 수정
	        JexData idoIn1 = util.createIDOData("BLBD_HSTR_U003");
	    
	        idoIn1.putAll(input);
	        idoIn1.put("BLBD_NO"	, Long.parseLong(input.getString("BLBD_NO")));
	        idoIn1.put("CORR_ID"	, USER_NM);
	    	...
	    	// 게시글 첨부파일 일괄삭제
	        JexData idoIn2 = util.createIDOData("BLBD_FILE_D001");
			...
			while(inputRecInsert.next()){
				...
				idoIn3.put("BLBD_NO"	, Long.parseLong(input.getString("BLBD_NO")));
