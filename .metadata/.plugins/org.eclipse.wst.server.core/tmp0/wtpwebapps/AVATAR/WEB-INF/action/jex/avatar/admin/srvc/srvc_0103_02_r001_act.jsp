...
<%
         ...
         *
         * @File Title   : 인텐트관리 수정 데이터 가져오기
         * @File Name    : srvc_0103_02_r001_act.jsp
         * @File path    : admin.srvc
         * @author       : byeolkim89 (  )
         * @Description  : 
         * @Register Date: 20200311110118
         * </pre>
         *
         * ============================================================
         * 참조
        ...
        @JexDataInfo(id="srvc_0103_02_r001", type=JexDataType.WSVC)
...
// IDO Connection
        ...
        JexData idoIn2 = util.createIDOData("INTE_INFM_R008");
        idoIn2.put("INTE_CD", input.getString("INTE_CD"));
