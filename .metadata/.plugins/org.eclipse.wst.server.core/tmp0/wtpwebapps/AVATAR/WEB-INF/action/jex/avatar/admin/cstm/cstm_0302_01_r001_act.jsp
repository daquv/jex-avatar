...
<%
		...
		*
		* @File Title   : 거래처 일괄등록 엑셀 파일 열기
		* @File Name    : cstm_0302_01_r001_act.jsp
		* @File path    : admin.cstm
		* @author       : byeolkim89 (  )
		* @Description  : 
		* @Register Date: 20210408171511
		* </pre>
		*
		* ============================================================
		* 참조
		...
		**/
		...
		@JexDataInfo(id = "cstm_0302_01_r001", type = JexDataType.WSVC)
			...
			for (rowindex = START_COL - 1; rowindex < rows; rowindex++) {
				...
				if (row != null) {
					...
					for (columnindex = 0; columnindex < cells; columnindex++) {
						...
						else if (2 == (columnindex)) {key = "HEAD_WD";} 
						else if (3 == (columnindex)) {key = "READ_SD";}
