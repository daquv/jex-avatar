...
<%
         ...
         *
         * @File Title   : 데이터_매출세금계산서목록조회
         * @File Name    : tax_0003_01_r001_act.jsp
         * @File path    : tax
         * @author       : byeolkim89 (  )
         * @Description  : 데이터_매출세금계산서목록조회
         * @Register Date: 20200120162817
         * </pre>
         *
         * ============================================================
         * 참조
        ...
        @JexDataInfo(id="tax_0003_01_r001", type=JexDataType.WSVC)
        ...
        dynamic_0.addNotBlankParameter(input.getString("BILL_TYPE"), "\n AND BILL_TYPE = ?");
        //cnt
        JexData idoIn2 = util.createIDOData("ELEC_TXBL_PTCL_R005"); 
        idoIn2.putAll(input);
        ...
        // order
        dynamic_0.addSQL("\n ORDER BY WRTG_DT DESC, TOTL_AMT DESC");
		// paging
        ...
        JexData idoIn1 = util.createIDOData("ELEC_TXBL_PTCL_R002");
