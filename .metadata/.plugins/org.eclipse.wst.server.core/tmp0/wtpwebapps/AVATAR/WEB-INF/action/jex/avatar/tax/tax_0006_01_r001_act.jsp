...
<%
         ...
         *
         * @File Title   : 매입현금영수증목록조회
         * @File Name    : tax_0006_01_r001_act.jsp
         * @File path    : tax
         * @author       : byeolkim89 (  )
         * @Description  : 매입현금영수증목록조회
         * @Register Date: 20200131171226
         * </pre>
         *
         * ============================================================
         * 참조
        ...
        @JexDataInfo(id="tax_0006_01_r001", type=JexDataType.WSVC)
    	...
    	//CNT
        JexData idoIn1 = util.createIDOData("CASH_RCPT_BUY_HSTR_R002");
        ...
        JexData idoIn2 = util.createIDOData("CASH_RCPT_BUY_HSTR_R001");
