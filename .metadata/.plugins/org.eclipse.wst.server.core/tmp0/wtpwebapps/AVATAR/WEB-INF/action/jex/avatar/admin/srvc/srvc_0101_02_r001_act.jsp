...
<%
         ...
         *
         * @File Title   : 앱담당자조회
         * @File Name    : srvc_0101_02_r001_act.jsp
         * @File path    : admin.srvc
         * @author       : byeolkim89 (  )
         * @Description  : 
         * @Register Date: 20200706155509
         * </pre>
         *
         * ============================================================
         * 참조
        ...
        @JexDataInfo(id="srvc_0101_02_r001", type=JexDataType.WSVC)
...
// IDO Connection
        ...
        JexData idoIn1 = util.createIDOData("APP_CHRG_INFM_R001");
