...
<%
         ...
         *
         * @File Title   : 거래처 목록 조회
         * @File Name    : bzaq_0001_01_r001_act.jsp
         * @File path    : bzaq
         * @author       : byeolkim89 (  )
         * @Description  : 
         * @Register Date: 20200211091125
         * </pre>
         *
         * ============================================================
         * 참조
        ...
        @JexDataInfo(id="bzaq_0001_01_r001", type=JexDataType.WSVC)
        ...
        dynamic_0.addNotBlankParameter(input.getString("SRCH_WD"), "\n AND BZAQ_NM ILIKE '%'||?||'%'");
      	//cnt
        JexData idoIn2 = util.createIDOData("BZAQ_INFM_R003"); 
        idoIn2.putAll(input);
        ...
        dynamic_0.addSQL("ORDER BY BZAQ_NM");
     // paging
        ...
        JexData idoIn1 = util.createIDOData("BZAQ_INFM_R002");
