...
<%
         ...
         *
         * @File Title   : 고객별 데이터 출처 조회
         * @File Name    : ques_comm_01_r007_act.jsp
         * @File path    : ques
         * @author       : byeolkim89 (  )
         * @Description  : 
         * @Register Date: 20210512145000
         * </pre>
         *
         * ============================================================
         * 참조
        ...
        @JexDataInfo(id="ques_comm_01_r007", type=JexDataType.WSVC)
...
// IDO Connection
		...
		JexData idoIn1 = util.createIDOData("CUST_LDGR_R025");
