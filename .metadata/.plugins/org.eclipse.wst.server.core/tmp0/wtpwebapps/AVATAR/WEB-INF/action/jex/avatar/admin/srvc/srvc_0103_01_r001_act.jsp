...
<%
         ...
         *
         * @File Title   : admin 인텐트관리 목록 조회
         * @File Name    : srvc_0103_01_r001_act.jsp
         * @File path    : admin.srvc
         * @author       : byeolkim89 (  )
         * @Description  : 
         * @Register Date: 20200309162445
         * </pre>
         *
         * ============================================================
         * 참조
        ...
        @JexDataInfo(id="srvc_0103_01_r001", type=JexDataType.WSVC)
		...
		//카테고리
		/* if(!"".equals(StringUtil.null2void(input.getString("INTE_DV")))){
			dynamic_0.addNotBlankParameter(input.getString("INTE_DV"), "\n AND INTE_DV = ? ");
		} */
		//검색대상
		if(!"".equals(StringUtil.null2void(input.getString("SRCH_WD")))){
			...
			if("0".equals(StringUtil.null2void(input.getString("SRCH_CD")))){
				...
				dynamic_0.addNotBlankParameter(input.getString("SRCH_WD"), "\n OR QUES_CTT like '%'||?||'%' "); //유사검색어
				dynamic_0.addNotBlankParameter(input.getString("SRCH_WD"), "\n OR INTE_CD like '%'||?||'%' ) "); //인텐트 코
			}
			//인텐트
		...
		//cnt
		JexData idoIn2 = util.createIDOData("INTE_INFM_R003");
		idoIn2.putAll(input);
		...
		JexData idoIn1 = util.createIDOData("INTE_INFM_R002");
		dynamic_0.addSQL("\n ORDER BY CORC_DTM DESC, REG_DTM DESC");
		//paging
