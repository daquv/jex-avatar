	...
	if(top==window)
	{
		var _JexLoding = JexPlugin.extend({
			init : function() {
				...
				var $imgDiv = $("<div id='jexLoading_img' style='display:none;margin-left: 0 !important;position: absolute;text-align: center;top: 30%;width: 100%;'><img alt='잠시만 기다려주세요.' src='/img/loading/loader2_1.gif' ></div>");
