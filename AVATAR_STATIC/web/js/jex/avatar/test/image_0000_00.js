...
//			});
		...
		fn_grid: function(){
			...
			list.push({DISPLAY_YN:"Y", MDTY_YN:"N", USE_YN:"Y", VIEW_ID:"BLBD_TITL",	VIEW_NM:"제목",		VIEW_STYLE : "width=400px;",
					   ...
					   ONCLICK:"click_edit", 
					   ONCLICKDATA: "BLBD_NO"});
			list.push({DISPLAY_YN:"Y", MDTY_YN:"N", USE_YN:"Y", VIEW_ID:"IMG_IN"   , VIEW_NM:"첨부파일"});
...
function FileUpload(){
	...
	formData.append("keepfilenameYn","true");
	$.ajax({
