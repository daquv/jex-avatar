...
$(function(){
	...
	$("#btnRegi").click(function(){
		location.href = "blbd_0101_02.act?BLBD_DIV=03";
	});
	$(document).on("click",".click_edit",function() {
		var data;
		data = {BLBD_NO : $(this).data("blbd_no")};
		location.href = "blbd_0101_02.act?BLBD_DIV=03&BLBD_NO="+data.BLBD_NO;
	});
...
var _thisPage = {
		...
		fn_search : function(pageNo){
			...
			input["CHNL_CD"]	= $("#CHNL_CD").val();
			input["BLBD_DIV"]	= "03"; 	//FAQ
		...
		fn_grid: function(){
			...
			list.push({DISPLAY_YN:"Y", MDTY_YN:"N", USE_YN:"Y", VIEW_ID:"BLBD_CHNL_NM",	VIEW_NM:"채널",	VIEW_STYLE : "width=100px;"});
			list.push({DISPLAY_YN:"Y", MDTY_YN:"N", USE_YN:"Y", VIEW_ID:"BLBD_CTGR_NM",	VIEW_NM:"카테고리",	VIEW_STYLE : "width=100px;"});
