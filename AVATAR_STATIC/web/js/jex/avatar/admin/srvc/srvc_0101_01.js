...
var _thisPage = {
		...
		fn_grid: function(){
			var list = [];
			list.push({DISPLAY_YN:"Y", MDTY_YN:"N", USE_YN:"Y", VIEW_ID:"BSNN_NM",				VIEW_NM:"컨텐츠공급사",			VIEW_STYLE : "width=120px;"});
		...
		fn_detail : function(data){
			location.href = "srvc_0101_02.act?APP_ID="+ fintech.common.null2void(data.APP_ID)
		}
}
