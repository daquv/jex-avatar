 ...
 **/
$(function(){
	if(_APP_ID === "ZEROPAY") { /* 제로페이는 웹액션 사용 안함 */} 
	else { iWebAction("changeTitle",{"_title" : "질의", "_type" : "2"}); }
	_thisPage.onload();
});
...
var _thisPage = {
		...
		setData : function(){
			...
			var inteCd4 = ",SCT002,";
			var inteCd5 = ",BDW005,";
			var inteCd6 = ",SPN002,BST001,BPT001,ZNN006,ZNN007,";
