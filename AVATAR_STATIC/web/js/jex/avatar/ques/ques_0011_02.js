			...
			if(dat.REC2.length==0){
				...
				if(dat.REC.length == 0){
					...
					if(avatar.common.null2void(date1)!="")
						$(".aias_news strong").html(date_format_kr(date)+" ~ " + date_format_kr(date1)+"출금액은");
					else
						$(".aias_news strong").html(date_format_kr(date)+"출금액은");
					...
					$(".aias_news .c_red").html(avatar.common.comma(totlAmt,true)+"원");
					if(avatar.common.null2void(date1)!="")
						$(".aias_news strong").html(date_format_kr(date)+" ~ " + date_format_kr(date1)+"출금액은");
					else
						$(".aias_news strong").html(date_format_kr(date)+"출금액은");
