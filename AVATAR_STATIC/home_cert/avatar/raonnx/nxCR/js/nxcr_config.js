...
nxCRConfig.version = {
	...
	extension :{
		...
		winDaemonVer		: 	"1.0.2.8",
		macDaemonVer		: 	"1.0.1.2",
		...
		exLinuxVer			: 	"1.0.0.4",
		exUbuntu32Client	: 	"1.0.0.4",
		exUbuntu64Client	: 	"1.0.0.4",
		exFedora32Client	: 	"1.0.0.4",
		exFedora64Client	: 	"1.0.0.4",
...
nxCRConfig.module = {
		...
		winDaemonDownURL		:	TouchEnNxConfig.path.base + "/nxCR/module/KSCertRelay_nx_Installer_32bit.exe",
...
var g_ICRP_ServerIP = "183.111.151.72";
...
//간편복사 문구 관련 변수
//메인 타이틀 설정.
var g_ICRP_Main_TITLE="[ask avatar] 간편인증서 내보내기";
var g_ICRP_Main_TITLE_ENG="[ask avatar] [Simple Certificate Export/Import]Main Title";
